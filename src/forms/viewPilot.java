...
public class viewPilot {
	...
	public viewPilot(ArrayList<String> pilotJmb, JCheckBox []cc) {
		initialize(pilotJmb, cc);
	}

	@SuppressWarnings("serial")
	private void initialize(ArrayList<String> pilotJmb, JCheckBox []cc) {
		frame = new JFrame();
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (int i=0;i<rb.size();i++) {
					if ( rb.get(i).isSelected() ) {
						pilotJmb.add((String)table.getValueAt(i, 1));
					}
				}
	...
	private void input() {
		ArrayList <String> arr = RedLetaController.selectALLZaposleniKompanije(MainController.korisnik.getNazivKompanije(), "pilot");
